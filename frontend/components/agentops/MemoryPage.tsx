...
.mem-search input::placeholder { color: #B5AFA5; }
.mem-search kbd {
...
.mem-search-clear:hover { color: #1F1915; }
...
.mem-tab:hover { color: #1F1915; }
.mem-tab.is-active { color: #0000CD; }
...
.mem-card {
  ...
  box-shadow: 0 2px 8px rgba(31, 25, 21, 0.04);
}
.mem-card:hover {
  border-color: #DDD9D1;
  box-shadow: 0 4px 14px rgba(31, 25, 21, 0.07);
}

.mem-skeleton {
  height: 140px;
  background: linear-gradient(90deg, #FAF9F5 0%, #F5F3ED 50%, #FAF9F5 100%);
...
.mem-icon-btn:hover { background: #F5F3EF; color: #1F1915; }
.mem-icon-btn.is-pinned { color: #0000CD; opacity: 1; }
.mem-icon-btn-danger:hover { background: #FDF2F2; color: #D84C4C; }
...
.mem-btn-ghost:hover { color: #1F1915; border-color: #B5AFA5; background: #F5F3EF; }
.mem-btn-danger {
  background: #D84C4C;
  border: 1px solid #D84C4C;
  color: #FFFFFF;
...
.mem-btn-danger:hover { background: #C43C3C; }
